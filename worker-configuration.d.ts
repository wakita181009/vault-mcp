/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9fc38db9c0ff8817357b7bbab2df061b)
// Runtime types generated with workerd@1.20260714.1 2025-03-10 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	VAULT_OWNER: "wakita181009";
	VAULT_REPO: "vault";
	VAULT_BRANCH: "main";
	ALLOWED_GITHUB_LOGINS: "wakita181009";
	VAULT_ALLOWED_PREFIXES: "";
	VAULT_DENIED_PREFIXES: ".git/,.obsidian/,.claude/,claude-projects/";
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").VaultMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VaultMCP";
	}
